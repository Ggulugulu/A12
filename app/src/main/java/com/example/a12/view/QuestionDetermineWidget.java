 ...
 * @Description 判断题
 */
public class QuestionDetermineWidget extends BaseQuestionWidget implements View.OnClickListener{

    protected RadioGroup radioGroup;

    public QuestionDetermineWidget(Context context) {
        super(context);
    }

    public QuestionDetermineWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
