 ...
 * @Description 多选题
 */
public class QuestionChoiceWidget extends BaseQuestionWidget implements View.OnClickListener {

    protected RadioGroup radioGroup;


    public QuestionChoiceWidget(Context context) {
        super(context);
    }

    public QuestionChoiceWidget(Context context, AttributeSet attributeSet) {
...
//        }
    ...
    protected void sendMsgToTestpaper() {
        Log.i("BaseQuestionWidget", "事件被触发了");
